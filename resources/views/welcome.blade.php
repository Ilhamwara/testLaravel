...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <select class="form-control mesin_id" name="mesin_id">
                                            <option value="">-- SELECT MESIN ID --</option>
                                            <option value="LYK01">LYK01</option>
                                            <option value="LYK02">LYK02</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/2.0.8/js/dataTables.bootstrap4.min.js"></script>
    {{ $dataTable->scripts() }}
    <script type="text/javascript">
        ...
        $('.mesin_id').on('change',function(){
            var mesin_id = $(this).val();
            var month = $('.month').find(':selected').val();
            var code = $('.code').find(':selected').val();

            var url = '?mesin_id='+mesin_id+'&&month='+month+'&&code='+code;
            var table = $('#transactiondatatables-table').DataTable();
            table.ajax.url(url).load();
            // reloadDataTable('transactiondatatables-table');
        });
